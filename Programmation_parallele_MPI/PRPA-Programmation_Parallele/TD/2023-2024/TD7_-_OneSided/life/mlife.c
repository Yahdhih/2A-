...
/* OPTIONS */
static int opt_rows = 50, opt_cols = 100, opt_iter = 20;
...
int main(int argc, char *argv[])
{
    ...
    MPI_Init(&argc, &argv);
    // Inerpretation des arguments du programme
...
double life(int rows, int cols, int ntimes, MPI_Comm comm)
{
    ...
    // TODO 0 Use MPI_Reduce to sum up the computationnal time of
    // each process in totaltime
